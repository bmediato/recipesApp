...
export const FAILED_MOCK_DRINKS = { drinks: null };

export const MOCKED_ONE_DRINK = { drinks: [{
  strDrink: 'Imperial Fizz',
  strDrinkThumb: 'https://www.thecocktaildb.com/images/media/drink/zj1usl1504884548.jpg',
  idDrink: '11524',
}] };

export const MOCKED_MEALS = {
  meals: [
    {
...
export const FAILED_MOCK_MEALS = { meals: null };

export const MOCKED_ONE_MEAL = { meals: [{
  strMeal: 'Peanut Butter Cookies',
  strMealThumb: 'https://www.themealdb.com/images/media/meals/1544384070.jpg',
  idMeal: '52958',
}] };
